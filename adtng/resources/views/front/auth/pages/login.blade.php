            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Log In to <a href="{{ route('index') }}"><span class="brand-name">ADT</span></a></h1>
                        ...
                        <form class="text-left" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form">
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input id="password" name="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Enter Password" required autocomplete="current-password">
