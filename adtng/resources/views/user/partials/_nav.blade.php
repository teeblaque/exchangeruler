        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="{{ route('index') }}">
                        <img src="{{ asset('images/ADTlogo.png') }}" class="navbar-logo" alt="logo">
                    </a>
                </li>
                {{-- <li class="nav-item theme-text">
                    <a href="{{ route('index') }}" class="nav-link"> ADT </a>
                </li> --}}
            </ul>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>@yield('description')</span></li>
                            </ol>
                        </nav>
