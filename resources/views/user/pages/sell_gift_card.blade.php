            ...
            <div class="row my-3">
                <div class="col-md-12">
                    <div class="card r-0 shadow">
                        ...
                        <div class="card-body">
                            <form id="addOrder" method="POST" action="{{ route('user.sell.gift_card') }}" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <button id="btn-addOrder" type="submit" class="btn btn-success pull-right float-right" readonly><i class="anticon anticon-edit"></i> Create Order </button>
                                </div>
                            </div>
                        </form>
                    </div>
